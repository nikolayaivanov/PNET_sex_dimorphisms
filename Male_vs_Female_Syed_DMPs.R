...
# find DMPs
all_DMPs_rda_filename="/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/DNAm_analysis/rdas/MaleVsFemale_Syed_all_DMPs.rda"
all_DMPs_csv_filename="/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/DNAm_analysis/data_tables/MaleVsFemale_Syed_all_DMPs.csv"
DMPs_proximal_to_genes_rda_filename="/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/DNAm_analysis/rdas/MaleVsFemale_Syed_DMPs_proximal_to_genes.rda"
DMPs_proximal_to_genes_csv_filename="/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/DNAm_analysis/data_tables/MaleVsFemale_Syed_DMPs_proximal_to_genes.csv"
pdf_filename='/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/DNAm_analysis/pdfs/MaleVsFemale_Syed_DMPs.pdf'
...
save(svaobj, file='/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/DNAm_analysis/rdas/MaleVsFemale_Syed_svaobj.rda')
...
num_dmps=length(which(probeFit$fdr<=0.1)) # 38623

percent_dmps=length(which(probeFit$fdr<=0.1))/nrow(probeFit) #0.08452754
