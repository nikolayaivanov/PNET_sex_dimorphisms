...
metadata_Chan=metadata_Chan[grep('pancreas', metadata_Chan$tumor_in_specimen, ignore.case=TRUE),]
metadata_Chan$tumor_in_specimen='Pancreas'
...
summary(rr)
# out of 33797 with nonzero total read count
...
length(which(GO.KEGG.wall$over_represented_FDR<=0.1)) # 6
...
# SRR7634542; SRR7634528
tpm_dup_rm_excluding_SRR7634542_SRR7634528=tpm_dup_rm[,-which(colnames(tpm_dup_rm) %in% c('SRR7634542','SRR7634528'))]
res_epic = deconvolute(tpm_dup_rm_excluding_SRR7634542_SRR7634528, method="epic", tumor = TRUE)
